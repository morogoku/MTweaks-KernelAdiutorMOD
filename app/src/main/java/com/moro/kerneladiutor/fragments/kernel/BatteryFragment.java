...
import com.moro.kerneladiutor.fragments.DescriptionFragment;
import com.moro.kerneladiutor.fragments.RecyclerViewFragment;
import com.moro.kerneladiutor.utils.Utils;
import com.moro.kerneladiutor.utils.kernel.battery.Battery;
...
import com.moro.kerneladiutor.views.recyclerview.StatsView;
...
public class BatteryFragment extends RecyclerViewFragment {
    ...
    private void chargeS7Init(List<RecyclerViewItem> items) {
        ...
        hv_input.setSummary(getString(R.string.def) + ": " + Battery.getS7HvInput() + getString(R.string.ma));
        ...
        hv_charge.setSummary(getString(R.string.def) + ": " + Battery.getS7HvCharge() + getString(R.string.ma));
        ...
        ac_input.setSummary(getString(R.string.def) + ": " + Battery.getS7AcInput() + getString(R.string.ma));
        ...
        ac_charge.setSummary(getString(R.string.def) + ": " + Battery.getS7AcCharge() + getString(R.string.ma));
        ...
        ac_input_screen.setSummary(getString(R.string.def) + ": " + Battery.getS7AcInputScreen() + getString(R.string.ma));
        ...
        ac_charge_screen.setSummary(getString(R.string.def) + ": " + Battery.getS7AcChargeScreen() + getString(R.string.ma));
        ...
        usb_input.setSummary(getString(R.string.def) + ": " + Battery.getS7UsbInput() + getString(R.string.ma));
        usb_input.setMax(1200);
        usb_input.setMin(400);
        usb_input.setUnit(getString(R.string.ma));
        usb_input.setOffset(25);
        usb_input.setProgress(Utils.strToInt(Battery.getS7UsbInput()) / 25 - 16);
        usb_input.setOnSeekBarListener(new SeekBarView.OnSeekBarListener() {
            @Override
            public void onStop(SeekBarView seekBarView, int position, String value) {
                Battery.setS7UsbCharge((position + 16) * 25, getActivity());
            }
        ...
        usb_charge.setSummary(getString(R.string.def) + ": " + Battery.getS7UsbCharge() + getString(R.string.ma));
        usb_charge.setMax(1200);
        usb_charge.setMin(400);
        usb_charge.setUnit(getString(R.string.ma));
        usb_charge.setOffset(25);
        usb_charge.setProgress(Utils.strToInt(Battery.getS7UsbCharge()) / 25 - 16);
        ...
        wc_input.setSummary(getString(R.string.def) + ": " + Battery.getS7WcInput() + getString(R.string.ma));
        ...
        wc_charge.setSummary(getString(R.string.def) + ": " + Battery.getS7WcCharge() + getString(R.string.ma));
